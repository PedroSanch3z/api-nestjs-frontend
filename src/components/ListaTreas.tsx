...
const handleUpdateTarea = async (id: string) => {
    try {
      ...
      const updatedTareas = await fetchTareas();
        ...
        {tareas.map((tarea, index) => (
          <li 
            ...
            <div>
                ...
                <IoMdClose onClick={() => handleDeleteTarea(tarea._id)} className=" text-zinc-700 text-2xl hover:cursor-pointer hover:text-zinc-900 hover:font-bold"/>
          </li>
        ))}
      </ul>
